...
public class GFace extends GCompound {
	public GFace(double width, double height){
		...
		leftPupil = new GOval(0.25 * width - PUPIL * width / 2, 0.25 * height - PUPIL * height / 2, PUPIL * width, PUPIL * width);
		leftPupil.setFilled(true);
		rightPupil = new GOval(0.75 * width - PUPIL * width / 2,
			      0.25 * height - PUPIL * height / 2, PUPIL * width, PUPIL * width);
...
//		add(leftPupil, 0.25 * width - PUPIL * width / 2, 0.25 * height - PUPIL * height / 2);
//		add(rightPupil, 0.75 * width - PUPIL * width / 2,
//			      0.25 * height - PUPIL * height / 2);
	}
	...
	private static final double PUPIL        = 0.05;
