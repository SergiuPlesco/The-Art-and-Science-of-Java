...
//	private void xyBits(){
//		xBits = new ArrayList<GLabel>(8);
//		yBits = new ArrayList<GLabel>(8);
//		
//		double xBitsCoord = 100;
//		double yBitsCoord = 100;
//			for(int i = 0; i < 8; i++){
//				final GLabel lbl = new GLabel("0", xBitsCoord+=25, 300);
...
//							  lbl.setLabel("0");
//						  }
//						xPoint = new GPoint(e.getPoint());
//						xObj = getElementAt(xPoint);
//						xBitsindex = xBits.indexOf(xObj);
//						GLabel xLbl = xBits.get(xBitsindex);
//						String xS = xLbl.getLabel();
//						int xBit = Integer.parseInt(xS);
//						
//						GLabel yLbl = yBits.get(xBitsindex);
//						yBitsindex = yBits.indexOf(yLbl);
//						String yS = yLbl.getLabel();
//						int yBit = Integer.parseInt(yS);
//						
//						
//					
//						
//						 println("top X: " + xBitsindex + ", Y: " + yBitsindex);
//						 println(xBit | yBit);
//						 loop();
////						 int res = xBit | yBit;
////						 String resStr = Integer.toString(res);
////						 result.get(xBitsindex).setLabel(resStr);
//					}
//
//					@Override
...
//			/*  */
//			for(int i = 0; i < 8; i++){
//				final GLabel lbl = new GLabel("0", yBitsCoord+=25, 325);
//				lbl.addMouseListener(new MouseListener(){
//					@Override
//					public void mouseClicked(MouseEvent e) {
//						// TODO Auto-generated method stub
...
//							  lbl.setLabel("0");
//						  }
//						yPoint = new GPoint(e.getPoint());
//						yObj = getElementAt(yPoint);
//						yBitsindex = yBits.indexOf(yObj);
//						GLabel yLbl = yBits.get(yBitsindex);
//						String yS = yLbl.getLabel();
//						int yBit = Integer.parseInt(yS);
//						
//						GLabel xLbl = xBits.get(yBitsindex);
//						xBitsindex = xBits.indexOf(xLbl);
//						String xS = xLbl.getLabel();
//						int xBit = Integer.parseInt(xS);
//					
//						println("Bottom X: " + xBitsindex + ", Y: " + yBitsindex);
//						println(xBit & yBit);
//						loop();
//					}
//
...
//		result = new ArrayList<GLabel>(8);
//		double xResult = 100;
//		
//		for(int i = 0; i < 8; i++){
//			final GLabel lbl = new GLabel("0", xResult+=25, 350);
//			result.add(lbl);
//			add(result.get(i));
//		}
//	}
